...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div>
        ...
        <input type="number" name="sponsorship_token_cost" min="1" value="{{ old('sponsorship_token_cost', ((int) ($tool?->sponsorship_token_cost ?? 0)) > 0 ? $tool->sponsorship_token_cost : config('toolbox.default_sponsorship_token_cost', 10)) }}" required
               class="w-full bg-zinc-800 border border-zinc-700 rounded-2xl px-4 py-3 text-white focus:outline-none focus:border-emerald-500">
