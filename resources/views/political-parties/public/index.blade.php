...
@section('title', 'Political Parties - My Leader Kenya')
@section('meta_description', 'Explore published political parties and their profiles in Kenya.')
...
<section class="party-hero"><div class="party-eyebrow"><span class="dot"></span> Political Directory</div><h1>Political <em>Parties</em></h1><p>Explore published political parties, their profiles, websites, and coalition relationships.</p></section>
<section class="party-grid">
@forelse($politicalParties as $party)
    <x-public-party-card :item="$party" type="Political Party" :url="route('parties.show', $party->slug)" />
@empty
    <div class="party-empty"><h3>No political parties published yet.</h3><p>Published political parties will appear here automatically.</p></div>
@endforelse
</section>
@if($politicalParties->hasPages())<div class="party-pagination">{{ $politicalParties->links() }}</div>@endif
@endsection
