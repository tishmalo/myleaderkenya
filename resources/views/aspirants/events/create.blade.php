...
<p class="news-kicker">Aspirant Dashboard</p><h1 class="news-title">Submit an event</h1><p class="news-subtitle">Your event stays private until an administrator approves it. Pricing is managed by the platform.</p>
