...
<p class="news-kicker">My Account</p><h1 class="news-title">My events</h1><p class="news-subtitle">Track every event you have submitted. Each one remains private until an administrator approves it.</p>
<div class="news-actions"><a class="news-button primary" href="{{ route('account.events.create') }}"><i class="fas fa-plus"></i>&nbsp; Submit Event</a></div>
...
@empty<div class="news-empty"><p>You have not submitted any events yet.</p><a class="news-button primary" href="{{ route('account.events.create') }}">Submit your first event</a></div>
@endforelse
</div>
