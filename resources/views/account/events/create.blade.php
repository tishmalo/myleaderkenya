...
<p class="news-kicker">My Account</p><h1 class="news-title">Submit an event</h1><p class="news-subtitle">Your event stays private until an administrator approves it. Set your own ticket price — enter 0 for a free event.</p>
