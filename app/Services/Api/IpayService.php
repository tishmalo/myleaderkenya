...
class IpayService
{
    ...
    public function userCheckoutUrl(UserTokenPurchase $purchase, User $user, CandidateTokenPackage $package, array $contact): string
    {
        $fields = [
            'live' => $this->live(),
            'oid' => (string) $purchase->checkout_reference,
            'inv' => (string) $purchase->checkout_reference,
