...
{
    use AuditsChanges;
    protected $fillable = ['user_id','candidate_token_package_id','provider','checkout_reference','package_name','token_amount','price','currency','payment_reference','gateway_transaction_code','gateway_status','gateway_response','callback_received_at','status','credited_at'];
